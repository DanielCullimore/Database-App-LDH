...
Dit is het project van groepje 3C. 
...
Aantekenigen:
	Java 8:
		Dit project is geschreven en Java 8. Vergeet de JDK niet om te zetten hin de project properties.

	Database Gebruiker:
		Er wordt gebruiker gemaakt van een gebruiker van de database wanneer er wordt ingelogd. Deze staat in de ConnectionDatabase.java Class
